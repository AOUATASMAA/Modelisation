...
/**
 * This is the item provider adapter for a {@link configuration.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.APPLICATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationPackage.Literals.APPLICATION__OWN);
			childrenFeatures.add(ConfigurationPackage.Literals.APPLICATION__POSSESS);
			childrenFeatures.add(ConfigurationPackage.Literals.APPLICATION__TO);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Application.class)) {
			...
			case ConfigurationPackage.APPLICATION__TO:
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.APPLICATION__OWN,
				 ConfigurationFactory.eINSTANCE.createProcfile()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.APPLICATION__POSSESS,
				 ConfigurationFactory.eINSTANCE.createmanifest()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.APPLICATION__TO,
				 ConfigurationFactory.eINSTANCE.createDockerfile()));
	}
