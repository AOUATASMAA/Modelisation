...
/**
 * This is the item provider adapter for a {@link configuration.Account} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccountItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.ACCOUNT__EMAIL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.ACCOUNT__PASSWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Account)object).getEmail();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Account.class)) {
			case ConfigurationPackage.ACCOUNT__EMAIL:
			case ConfigurationPackage.ACCOUNT__PASSWORD:
