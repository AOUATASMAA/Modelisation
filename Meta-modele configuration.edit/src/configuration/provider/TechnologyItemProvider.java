...
/**
 * This is the item provider adapter for a {@link configuration.Technology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationPackage.Literals.TECHNOLOGY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addUsedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Technology_Used_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Technology_Used_feature", "_UI_Technology_type"),
				 ConfigurationPackage.Literals.TECHNOLOGY__USED,
				 true,
				 false,
				 true,
				 null,
