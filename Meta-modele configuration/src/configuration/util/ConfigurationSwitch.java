...
public class ConfigurationSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConfigurationPackage.TYPE_SERVICE: {
				Type_service type_service = (Type_service)theEObject;
				Object result = caseType_service(type_service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
