...
/**
 * This is the item provider adapter for a {@link configuration.manifest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_manifest_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_manifest_name_feature", "_UI_manifest_type"),
				 ConfigurationPackage.Literals.MANIFEST__NAME,
				 true,
				 false,
				 false,
	...
	protected void addHostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_manifest_host_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_manifest_host_feature", "_UI_manifest_type"),
				 ConfigurationPackage.Literals.MANIFEST__HOST,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMemoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_manifest_memory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_manifest_memory_feature", "_UI_manifest_type"),
				 ConfigurationPackage.Literals.MANIFEST__MEMORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_manifest_instance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_manifest_instance_feature", "_UI_manifest_type"),
				 ConfigurationPackage.Literals.MANIFEST__INSTANCE,
				 true,
				 false,
				 false,
