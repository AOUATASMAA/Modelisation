...
public class ConfigurationItemProviderAdapterFactory extends ConfigurationAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link configuration.Dockerfie} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected DockerfieItemProvider dockerfieItemProvider;

	/**
	 * This creates an adapter for a {@link configuration.Dockerfie}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Adapter createDockerfieAdapter() {
		if (dockerfieItemProvider == null) {
			dockerfieItemProvider = new DockerfieItemProvider(this);
		}

		return dockerfieItemProvider;
	}
	...
	public void dispose() {
		...
		if (dockerfieItemProvider != null) dockerfieItemProvider.dispose();
	}
